...
const MODEL_LOGOS = {
  ...
  openai: 'https://freepnglogo.com/images/all_img/1702059309openai-logo-png.png',
  anthropic:
...
- All links should be in blue (\`<span style="color: #0077cc">\`) and should be clickable

For images:
- When mentioning AI models, reference them as: ![Model Name](${Object.entries(MODEL_LOGOS)
  .map(([model, url]) => `${model}: ${url}`)
  .join(' or ')})
- When mentioning team members, reference them as: ![Team Member](${Object.entries(TEAM_IMAGES)
