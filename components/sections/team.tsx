    ...
    <div className="relative max-w-[90rem] px-4 md:px-8 flex flex-col md:flex-row items-start justify-between">
      ...
      >
        <motion.h1
          ...
          className="text-4xl md:text-7xl font-extrabold mb-6 text-center"
        >
          {' '}
            ...
            <div className="flex items-center gap-4 pt-1">
              {member.schools.map((school: any) => (
                <img
                  ...
                  className={cn(
                    'w-auto pr-4',
                    member.name === 'Julien Bergerot' ? 'h-7 md:h-8' : 'h-6 md:h-6',
                    school === 'https://brand.ncsu.edu/img/logo/2x2white.jpg' && 'h-8'
                  )}
                />
              ))}
            </div>
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 bg-gray-50">
        <div className="max-w-[90rem] mx-auto">
          ...
          <div className="w-full flex flex-col items-end text-end mb-16">
            <h2 className="text-4xl font-extrabold text-gray-900 mb-4">{dictionary.team.member}</h2>
