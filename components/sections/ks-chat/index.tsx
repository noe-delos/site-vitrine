  ...
  const renderSimulatorForm = () => {
    ...
    return (
      <motion.div
        ...
        className="w-full p-4 md:p-6 rounded-xl bg-white shadow-sm shadow-sm space-y-4 mt-3"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 md:space-y-2.5">
            ...
            >
              ...
              <div className="w-full md:w-48 border-[1px] border-zinc-200 rounded-md">
                <CustomSelect
            ...
            >
              ...
              <input
                ...
                className={cn(
                  "w-full flex-1 px-3 py-2 rounded-lg border-[1px] border-zinc-200 bg-white focus:outline-none text-sm md:text-base",
                  formErrors.activity
            ...
            >
              ...
              <div className="border-[1px] border-zinc-200 rounded-md">
                <CustomSelect
            ...
            >
              ...
              <textarea
                ...
                onKeyDown={handleKeyDown}
                className={cn(
                  "w-full px-4 py-2 resize-none border-[1px] border-zinc-200 rounded-lg bg-white focus:outline-none text-sm md:text-base",
      ...
      >
        {messages.length === 0 ? (
          ...
          >
            ...
            {!showSimulator && (
              <p className="text-center text-zinc-500 mt-5 md:mt-0 mx-5 md:mx-0 mb-8 max-w-lg">
                ...
                {showSimulator ? (
                  ...
                  <form onSubmit={handleFormSubmit} className="relative">
                    {isTyping && selectedPrompt?.text ? (
                      <div className="w-full px-6 rounded-full bg-white shadow-sm">
                        <TypewriterEffect
                      ...
                      <input
                        ...
                        className="w-full py-3 px-6 rounded-full bg-white shadow-sm focus:outline-none  pr-24"
                        disabled={isLoading}
                      />
                    )}
                  ...
                  <div className="flex md:gap-3 mt-10 md:mt-6 md:w-full justify-center flex-col md:flex-row w-fit items-center mx-auto md:mx-0 gap-5">
                    {prompts.map((prompt) => (
                      <motion.button
                        ...
                        className="flex items-center gap-2 px-6 py-2 bg-white shadow-sm rounded-md shadow-sm hover:bg-zinc-200 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        whileHover={{
                          scale: 1.02,
            ...
            >
              ...
              >
                ...
                <div className="relative">
                  {isTyping && selectedPrompt?.text ? (
                    <div className="w-full py-3 px-6 rounded-full bg-white shadow-sm">
                      <TypewriterEffect
