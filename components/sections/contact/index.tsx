...
// Utiliser une interface plus permissive
		...
		<div className="relative z-10 text-center px-4">
			...
			>
				...
				{dictionary.contactPage.hero.title2 && (
					<span className="font-extrabold font-sans bg-clip-text text-transparent bg-gradient-to-r from-[#7066CB] to-blue-500 ml-2">
						{dictionary.contactPage.hero.title2}
					</span>
				)}
			</motion.h1>
...
const ContactPage: React.FC<ContactPageProps> = ({ dictionary, lang }) => {
	return (
