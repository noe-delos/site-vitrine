...
const StatItem = ({ number, label }: any) => (
	...
	>
		<div className="text-5xl md:text-6xl lg:text-7xl font-extrabold bg-gradient-to-b from-zinc-900 to-zinc-400é bg-clip-text text-transparent">
			{number}
		</div>
				...
				<div className="flex flex-col space-y-16">
					...
					>
						<div className="space-y-2 pb-5">
							...
							<h1 className="text-5xl md:text-5xl lg:text-7xl font-extrabold text-gray-900 leading-tight">
								{t.title}
							</h1>
						</div>
					...
					<div className="flex flex-col md:flex-row items-center max-w-7xl gap-20 md:gap-32 self-center space-y-8 md:space-y-0 lg:ml-20">
						...
						>
							<div className="px-6 md:w-[400px] border-l-[3px] border-gray-200">
								<blockquote className="text-md text-black">
									“{t.testimonial.quote}”
								</blockquote>
								<div className="mt-4 flex flex-row items-center gap-4">
									<img
										...
										alt="FDJ"
										className="w-[6rem] h-[2rem] object-contain"
									/>
