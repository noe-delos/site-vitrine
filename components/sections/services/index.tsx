...
const HeroSection = ({
  ...
  return (
    <div className="relative w-full min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-indigo-300 to-white">
      <div className="relative w-full max-w-7xl mx-auto px-4 py-20 pt-10 sm:pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="space-y-12">
            <motion.h1
              ...
              className="text-5xl lg:text-6xl font-extrabold leading-tight md:block hidden"
            >
              {dictionary.services.hero.title.part1}{" "}
              {lang === "fr" ? (
                <div className="flex flex-row gap-2 mt-1 font-extrabold">
                ...
                <>
                  ...
                  <div className="flex flex-row">
                    ...
                    <img
                      src="/fr/hero/aiStar.webp"
                      alt=""
                      className="size-4 mb-1 ml-1 self-end bottom-0 object-contain"
                    />
                  </div>
                </>
              )}
            ...
            <motion.h1
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.1 }}
              className="text-5xl lg:text-6xl font-extrabold text-center leading-[3rem] md:hidden block"
            >
              ...
              <div className=" flex-row gap-2 mt-1">
                ...
                <br />
                <span className="flex flex-row mt-2 items-center justify-center text-center">
                  ...
                  <img
                    src="/fr/hero/aiStar.webp"
                    alt=""
                    className="size-4 mb-2 ml-2 self-end bottom-0 object-contain"
                  />
                </span>
              </div>
            </motion.h1>
            ...
            >
              {dictionary.services.hero.stats.map(
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
          <div className="col-span-1 md:col-span-3 mb-8 md:mb-0">
            <div className="text-center md:text-left">
              ...
              <h2 className="text-3xl md:text-[2.5rem] leading-tight md:leading-[1.1] font-extrabold">
                Questions
                <br />
                fréquentes
              </h2>
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8 md:py-20">
      <div className="mb-8 md:mb-12">
        ...
        <h2 className="text-2xl md:text-4xl font-extrabold mt-4 mb-2">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12">
        <div className={`w-full lg:w-1/2 ${contentOrder}`}>
          <div className="space-y-10">
            ...
            <h2 className="text-4xl tracking-wide font-extrabold text-gray-900">
              {title}
            </h2>
              ...
              {features.map((feature, index) => (
                ...
                >
                  <Icon
                    icon={feature.icon}
                    className={
                      "size-5 text-indigo-600 flex-shrink-0 " + feature.color
                    }
                  />
