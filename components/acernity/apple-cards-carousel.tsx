...
export const Carousel = ({ items, initialScroll = 50 }: CarouselProps) => {
				...
				<AnimatePresence mode="wait">
					{!isHovered ? (
						...
						>
							...
							<p className="text-white text-xl md:text-3xl font-extrabold max-w-xs text-left [text-wrap:balance] font-sans mt-2">
								{card.title}
							</p>
						</motion.div>
					) : (
