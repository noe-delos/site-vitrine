...
export default function Expertise({ dictionary }: { dictionary: any }) {
  ...
  return (
    <div className="bg-white w-full pb-[15rem] md:pb-[23rem] overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center tracking-normal">
          ...
          >
            <motion.div variants={fadeInUp}>
              <div className="lg:text-4xl md:text-4xl flex flex-col xl:text-5xl sm:text-4xl xs:text-4xl text-2xl font-extrabold mb-6">
